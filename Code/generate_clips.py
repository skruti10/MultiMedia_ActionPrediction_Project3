...
def process_training_data(num_clips):
    ...
    @param num_clips: The number of clips to process. Default = 1000000 (set in __main__).
    ...
    for clip_num in range(num_prev_clips, num_clips + num_prev_clips):
        ...
        #print('Saving the compressed clip')
...
def main():
    ...
    print('call process_training_data with num_clips')
